...
void WinterEngine::Graphics::StandardEffect::SetLightCamera(const Camera& camera)
{
	mLightCamera = &camera;
}
...
void WinterEngine::Graphics::StandardEffect::SetShadowMap(const Texture& shadowMap)
{
